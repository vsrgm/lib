...
public class KitchenMonitorActivity extends AppCompatActivity {
    ...
    private final String statusTopic = "FrmEsp32/kitchen/status";
    private final String cmdTopic = "FrmMobile/esp32cam/kitchen/command";
    private final String imageTopic = "FrmEsp32/kitchen/image";
    private SharedPreferences prefs;
    private int syncMode = 0; // 0: MQTT, 1: IP, 2: Firebase
    private final java.util.List<String> discoveredNodes = new java.util.ArrayList<>();
