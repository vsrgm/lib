...
main(int argc, char **argv) 
{
	...
	checkCudaErrors(cudaHostAlloc((void **)&des_buffer, out_width*out_height*2, cudaHostAllocMapped));
...
while (count--) {
	...
	resize_kernel<<<192, 192>>>((int*) src_buffer_cu, (int*) des_buffer_cu, in_width, in_height, out_width, out_height, 192, 192);
	...
	printf("Time prev_tv %llu.%06llu cur_tv %llu.%06llu = %llu\n",(unsigned long long int)prev_tv.tv_sec,
								...
								((cur_tv.tv_sec-prev_tv.tv_sec)*1000000)+cur_tv.tv_usec-prev_tv.tv_usec);
}
